const testCases: [string, string, number][] = [
  ...
  ["Mod large dividend", "g = 56991359368 % 10000000;", 0],
  ["Mod large divisor", "g = 5 % 56991359368;", 0],
  ["Mod both large", "g = 56991359368 % 56991359369;", 0],
  ["Mod negative large dividend", "g = (0-56991359368) % 10000000;", 0],
  ["Mod max i32", "g = 2147483647 % 100;", 47],
  ["Mod min i32", "g = (0-2147483648) % 100;", -48],
  ["Mod just over i32 max", "g = 2147483648 % 100;", 0],
  ["Mod just under i32 min", "g = (0-2147483649) % 100;", 0],
  ["Bitwise and", "g = 3 & 5;", 1],
  ["Bitwise or", "g = 3 | 5;", 7],
